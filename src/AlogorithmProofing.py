...
for each_truck in test_trucks:
    ...
    truck_list_two.addTruck(each_truck, enviroment_two)

print("Sim 1:")
for each_truck in test_trucks:
    enviroment_one.process(unloading(enviroment_one, unloaders_one, truck_list_one, doors_one, baseline_one))

print("Sim 2:")

for each_truck in test_trucks:
    enviroment_two.process(unloading(enviroment_two, unloaders_two, truck_list_two, doors_two, baseline_two))
